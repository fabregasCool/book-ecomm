...
const SizeCreatePage = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      await axios.post(`http://localhost:9000/api/sizes/create`, {
        name,
      });
  ...
  return (
    <div className=" mt-5">
      <h1 className="mb-3 text-center">Créer une Taille</h1>
      <Helmet>
        <title> Créer une Size(Taille)</title>
      </Helmet>
